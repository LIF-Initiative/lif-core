...
| `sample-lde-target-test-model.json` | **Test artifact, not part of LIF.** Synthetic *target* model (`Sample LDE Target Test`) used to prove Learner Data Export fidelity end to end (#1224). Paired with [`../transformations/test/StateU-LIF_Sample-LDE-Target-Test__v1.0.json`](../transformations/test/StateU-LIF_Sample-LDE-Target-Test__v1.0.json); the manual steps are in [`../transformations/README.md`](../transformations/README.md) |
